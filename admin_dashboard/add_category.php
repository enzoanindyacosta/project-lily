...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO story_category (title) VALUES ('$title')";
  $result = $conn->query($sql);

  if ($result) {
    header("Location: story_category.php?success=Category Added Successfully!");
    exit();
  } else {
    header("Location: add_category.php?error=?error=Something Went Wrong!");
    exit();
  }
}
...
<head>
  ...
  <title>Add Category | Project Lilly | AIDA</title>
      ...
      <div class="col-6">
        <div class="card">
          <div class="card-header text-uppercase text-center bg-primary text-white">
            <span class="p-0 m-0 fs-5 fw-bold">Add New Category</span>
          </div>
          <div class="card-body p-4">
            ...
            <form method="POST" action="">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="title" placeholder="Enter Category Title" name="title" required minlength="3" maxlength="75" />
              </div>
