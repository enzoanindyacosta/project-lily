...
if (isset($_POST['submit'])) {
  ...
  if ($result) {
    ...
    header("Location: edit_user.php?error=Something Went Wrong!");
    exit();
  }
}
...
<head>
  ...
  <title>Edit User | Project Lilly | AIDA</title>
      ...
      <div class="col-6">
        <div class="card">
          <div class="card-header text-uppercase text-center bg-primary text-white">
            <span class="p-0 m-0 fs-5 fw-bold">Edit User</span>
          </div>
          <div class="card-body p-4">
            ...
            <form method="POST" action="">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="fullname" placeholder="Enter Fullname" name="fullname" required value="<?php echo $row['fullname']; ?>" minlength="3" maxlength="50">
              </div>
              <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="email" placeholder="Enter Email Address" name="email" required value="<?php echo $row['email']; ?>" minlength="3" maxlength="50">
              </div>
              <div class="mb-3">
                <label for="phone" class="form-label">Phone Number</label>
                <input type="tel" class="form-control" id="phone" placeholder="Enter Phone Number" name="phone" required value="<?php echo $row['phone']; ?>" minlength="10" maxlength="15">
              </div>
              <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <input type="text" class="form-control" id="password" placeholder="Enter Password" name="password" required value="<?php echo $row['password']; ?>" minlength="5" maxlength="20">
              </div>
